...
public class PtrBaseFrameDemo extends PtrBaseFrame {
    ...
    public PtrBaseFrameDemo(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews();
    }

    public PtrBaseFrameDemo(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initViews() {
        ...
        // special header
        RelativeLayout container = (RelativeLayout) LayoutInflater.from(getContext()).inflate(R.layout.ptr_rotate_frame_header, null);
